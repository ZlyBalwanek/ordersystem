...
<head>
    ...
    <title>Dezaktywacja ${user.name}</title>
</head>
<body>
...
<div class="container-fluid">
    <div id="deactivate-div">
        ...
        Czy napewno chcesz dezaktywować użytkowanika ${user.name} od id ${user.id}?<br/>

        <form:form modelAttribute="user">
            <button type="submit" formaction="/master/of/order/deactivate" formmethod="post">Tak</button>
            <button type="submit" formaction="/master/of/order/index">Nie</button>
